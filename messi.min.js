/* https://messijs.github.io/MessiJS/demos/
 * 
...
{
    var n=this;
    n.options=jQuery.extend({},Info.prototype.options,t||{});
...
Info.prototype=
        {
            ...
            show:function()
            {
                ...
                this.messi.animate({opacity:0},300,function()
                {
                    ...
                    t.visible=false;if(e)e.call();
                    if(t.options.unload)t.unload()});
                return this
            },resize:function(){if(this.options.modal)
                {
        ...
        jQuery.extend(Info,{
            ...
            ask:function(e,t,n)
                    {
                        var r=[{id:"yes",label:"Yes",val:"Y","class":"btn-success"},
                        ...
                        n=jQuery.extend(
                                ...
                                return new Info(e,n)},img:function(e,t)
                            {
                                var n=new Image;
                                jQuery(n).load(function()
                                {
                                    var e={width:jQuery(window).width()-50,
                            ...
                            load:function(e,t)
                            {
                                ...
                                var n={url:e,data:t.params,dataType:"html",cache:false,error:function(e,t,n){console.log(e.responseText)},success:function(e){new Info(e,t)}};jQuery.ajax(n)}});
